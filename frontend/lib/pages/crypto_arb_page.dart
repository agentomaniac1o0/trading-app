            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Icon(Icons.arrow_forward, size: 16, color: AppColors.secondaryColor(context)),
                  const SizedBox(width: 8),
                  _perfCard('Rendite', '${returnPct >= 0 ? '+' : ''}${returnPct.toStringAsFixed(1)}%',
                      returnPct >= 0 ? AppColors.positive : AppColors.negative,
                      subtitle: '${returnAbsolute >= 0 ? '+' : ''}${returnAbsolute.toStringAsFixed(0)}'),
                ],
              ),
            ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        _infoCol('Spot Gain', '${spotGain >= 0 ? '+' : ''}\$${spotGain.toStringAsFixed(4)}',
                            spotGain >= 0 ? AppColors.positive : AppColors.negative),
                        const SizedBox(width: 12),
